...
const AiWithIntegrity = () => {
  ...
  return (
    <div className="w-full h-[120vh]">
      <div className="text-white relative w-full h-full overflow-hidden">
        <div
          style={{
            backgroundImage:
          ...
          className="flex pt-36"
        >
          <div className="pl-[112px] w-[85%] flex flex-col gap-5">
            ...
            <p className="text-textTertiary text-p-xl">
            ...
            <div className="bg-onBackground border border-surfaceAccent rounded-full px-6 py-6 w-fit flex items-center gap-3">
          ...
          <div className="w-full">
            <div className="absolute right-[-5%] top-[-2%] w-[54%]">
              <img
      ...
      <div className="text-white w-full h-full px-[112px]">
        <div className="flex flex-col gap-4 justify-center items-center mt-32 mb-20">
          ...
          <p className="text-center">
            ...
            <p className="text-textTertiary text-xl font-medium">
              at every step of the way
            </p>
          </p>
        </div>

        <div className="flex flex-col gap-6 mb-44">
          <div className="flex gap-6">
            <div className="w-1/2 bg-onBackground rounded-xl flex flex-col justify-between items-center border border-surfaceAccent overflow-hidden">
          ...
          <div className="w-full h-[360px] bg-onBackground rounded-xl flex justify-between items-end border border-surfaceAccent overflow-hidden">
            <div className="w-full flex flex-col gap-2 px-5 pt-3 pb-5">
              <h1 className="text-xs font-medium text-textPrimary">
        ...
        <div className="flex flex-col gap-6 mb-44">
          <div className="flex gap-6">
            <div className="max-w-[42%] h-[470px] bg-onBackground rounded-xl flex flex-col justify-between items-center border border-surfaceAccent overflow-hidden">
            ...
            <div className="flex-1 h-[470px] bg-onBackground rounded-xl flex flex-col justify-between items-center border border-surfaceAccent overflow-hidden">
              <div className="w-full h-[317px]">
                <img
                  className="w-full h-full object-cover"
                  alt=""
          ...
          <div className="flex gap-6">
            ...
            <div className="max-w-[47%] h-[470px] bg-onBackground rounded-xl flex flex-col justify-between items-center border border-surfaceAccent overflow-hidden">
              <div className="w-full h-[317px]">
                {/* <img
                  className="w-full h-full object-cover"
                  alt=""
                ...
                <div className="w-full h-full flex justify-center items-baseline mt-6 gap-12 px-6">
        ...
        <div className="w-full my-52">
          ...
          >
            ...
            <div className="absolute left-0 top-0 w-[60%] h-full  flex flex-col gap-12 ml-20 justify-center">
        ...
        <div className="w-full my-52">
          <div
            ...
            className="border border-surfaceAccent rounded-2xl relative overflow-hidden"
          >
            <div className="absolute inset-0">
              <div
                className="absolute inset-0"
                style={{
                  background: `
            radial-gradient(circle at center, rgba(255, 166, 210, 0.15) 0%, rgba(255, 166, 210, 0.15) 10%, transparent 11%) no-repeat,
            radial-gradient(circle at center, rgba(255, 166, 210, 0.10) 0%, rgba(255, 166, 210, 0.10) 20%, transparent 21%) no-repeat,
            radial-gradient(circle at center, rgba(255, 166, 210, 0.05) 0%, rgba(255, 166, 210, 0.05) 30%, transparent 31%) no-repeat,
            radial-gradient(circle at center, rgba(255, 166, 210, 0.05) 0%, rgba(255, 166, 210, 0.05) 40%, transparent 41%) no-repeat
          `,
            ...
            <div className="absolute left-0 top-0 w-full h-full flex flex-col justify-center items-center">
              ...
              <p className="w-[70%] text-xl text-center font-medium text-textPrimary">
                {/* Launch fast with Infinite template for startups */}
