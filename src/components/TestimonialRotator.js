...
const TestimonalRotator = () => {
  return (
    <div className="horizontal-scroll-container relative">
            ...
            <div className="flex justify-between gap-1 items-center">
              ...
              <div className="">
                <img
                  alt=""
                  src={testimonal.logo}
                  className="desktop:max-w-[128px] tablet:max-w-[128px] max-w-[100px] rounded-md"
                />
              </div>
            </div>
      ...
      <div className="mobile:hidden small-mobile:hidden">
        <div className="horizontal-scroll">
          {testimonalsInfo.map((testimonal, index) => (
            <div key={index} className="scroll-item">
      ...
      <div className="absolute left-0 top-0 w-24 h-full bg-gradient-to-r from-background to-transparent mobile:hidden small-mobile:hidden" />
      <div className="absolute right-0 top-0 w-24 h-full bg-gradient-to-l from-background to-transparent mobile:hidden small-mobile:hidden" />
    </div>
  );
};
